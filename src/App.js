...
function App()
{
  ...
  return(
    <>
    <h1>Axios</h1>
    <h2>Weather report - using OpenWeathermap API</h2>
    City: <input type="text" onChange={(e)=>cityfun(e)} placeholder="Enter city name" value={city}></input>
    <br></br><br></br>
